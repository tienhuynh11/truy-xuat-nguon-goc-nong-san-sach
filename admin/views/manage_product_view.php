...
//Số bản ghi theo role
$so_ban_ghi = $obj->count_sp($admin_id, $admin_role);
...
//product_info theo role
$product_info = $obj->display_product_pagination($bat_dau, $ket_thuc, $admin_id, $admin_role);
...
<style>
    #xemchitiet .modal-dialog {
        max-width: 80%;
        /* Thiết lập kích thước tối đa cho modal */
    ...
    #xemchitiet .modal-body {
        max-height: 550px;
        /* Thiết lập chiều cao tối đa cho modal body */
        overflow-y: auto;
        /* Hiển thị thanh cuộn dọc khi cần thiết */
        word-wrap: break-word;
        /* Xuống hàng khi cần thiết */
        overflow-wrap: break-word;
        /* Xuống hàng khi cần thiết (phù hợp với các trình duyệt mới hơn) */
    }
