    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
                <a href="thongtin.php">
                    <span class="pcoded-micon"><i class="fa fa-user grid2-alt"></i></span>
                    <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Thông tin cá nhân</span>
                    <span class="pcoded-mcaret"></span>
                </a>
            </li>
            ...
            <?php if ($admin_role == 'Admin') { ?>
                <li class="pcoded-hasmenu">
                    <a href="manage_danhmuc_nx.php">
                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Danh mục NX</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                </li>
            <?php } ?>
            ...
            <li class="pcoded-hasmenu">
                <a href="manage_nhaxuong.php">
                    <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                    <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Nhà xưởng</span>
                    <span class="pcoded-mcaret"></span>
                </a>
            </li>
            <?php if ($admin_role == 'Admin') { ?>
