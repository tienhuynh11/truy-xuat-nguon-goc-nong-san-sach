...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2024 at 01:19 PM
...
(10000, 2, 11, 1, 11, 'Vú sữa', 'NSQN000', 'vu_sua_lo_ren_vinh_kim.jpg', ' tầm 300 - 500', '', '1', '', '', '', '', '2024-05-01 03:29:28', 'daxetduyet');
...
--
ALTER TABLE `caygiong`
  MODIFY `id_cg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10187;
...
--
ALTER TABLE `sanpham`
  MODIFY `id_sp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10931;
