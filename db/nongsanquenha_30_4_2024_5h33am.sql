...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 30, 2024 lúc 12:32 AM
...
(1, 'Vú sữa lò rèn', 'MCG003', ' Cây giống \"Vú sữa lò rèn\" có nguồn gốc từ khu vực núi lò rèn, có đặc điểm lá dày, hình dáng cây cao vươn mạnh, phát triển tốt trong điều kiện ẩm ướt.', 'Đại học Nông nghiệp', '2024-04-22', '2025-04-22', 'Trồng từ cành', 'cay_giong_vu_sua_lo_ren.jpg', 'minh@gmail.com', '2024-04-22 17:27:39'),
(2, 'Mít Thái', 'MITT-2123', ' Đặc điểm nổi bật của cây mít Thái là dễ trồng, năng suất cao, đậu trái quanh năm. Song, bà con có thể sẽ phải bất ngờ khi biết thêm về những dưỡng chất mà quả của nó bổ sung cho cơ thể. Quả mít Thái siêu sớm tự thân nó đã rất dồi dào chất dinh dưỡng. Nó là một loại quả nhiệt đới được thống kê với rất nhiều loại vitamin như vitamin A, C, canxi, sắt, kali, ma-giê… rất có lợi cho sức khỏe người dùng. Đây là phương pháp cho rất nhiều chị em phụ nữ muốn sở hữu một làn da căng bóng không tì vết. Ngoài ra, nó cũng xuất hiện trong những chế độ ăn healthy (chế độ ăn lành mạnh) ở nhiều người.', 'Đại học nông Lâm Cần Em', '22/4/2024', '22/9/2026', 'Đào hố rồi trồng vào sao đó lấp đất tưới cây vào rồi đợi nó lớn thôi', 'caymitthaigiong-4091.jpeg', 'tienchos@gmail.com', '2024-04-29 21:16:29'),
(3, 'Chanh không hạt', 'CHANHKH-1', 'Chanh không hạt là cây không gai, thích hợp và sinh trưởng tốt với khí hậu Việt Nam Hoa chanh không hạt mọc thành chùm, cánh hoa có màu trắng, dạng quả hơi dài, có vị chua và thơm.\r\nGiống chanh không hạt ít gai ở thân và quả giống với quả chanh truyền thống. Khi cành ở giai đoạn thành thục thì các gai bị thoái hóa, cây cho quả sai, một chùm cho 7-8 quả. Từ năm thứ 3 – 4 sẽ cho năng suất cao hơn. Chanh không hạt sẽ cho thu hoạch trên 10 năm mới bị thoái hóa\r\nCây có thể mọc cao đến 6m, thân cây không có gai, có tán lá tròn, trái chùm, không có hạt (hoặc chỉ có vài hạt).\r\nChanh không hạt là cho trái quanh năm. Cây còn có sức kháng bệnh rất mạnh, nhất là không thấy bị nhiễm bệnh vàng lá gân xanh như các loại cây có múi khác', 'Đại học hậu giang', '23/1/2023', '21/2/2025', 'Trồng trực tiếp', 'cahnh0hat.jpg', 'anhhao@gmail.com', '2024-04-29 21:21:24'),
(4, 'Giống lúa ST25', 'ST25-2', '   - Đặc sản Sóc Trăng\r\n- Gạo ngon giá tốt dành cho người có điều kiện bình dân. \r\n- Gạo thơm ngon dẻo vừa dễ nấu', 'Đặc sản Sóc Trăng', '23/1/2023', '21/2/2030', 'Xạ lên cánh đồng lúa', 'gaost25.jpg', 'anhcuong@gmail.com', '2024-04-29 21:25:50');
...
(12, 'Chuối Hột', 'hoatdong', '2024-04-25 04:10:16'),
...
(13, 0, 9, 0, 0, 'Vú sữa', 'đá', '371399452_1009194440311955_3419208062698528689_n.jpg', '', NULL, NULL, '', NULL, NULL, NULL, '2024-04-11 17:54:31', 'dangchoxetduyet'),
...
(19, 5, 6, 1, 7, 'Chuối Tá quạ', 'NSQN000', '662bfc4bf00c0_2901100.jpg', ' Từ 200.000 - 250.000đ/1kg', 'Vĩnh Xuân', '1', 'Quả chuối to ngon ngọt nước', '   Ăn ngon', 'Nấu trước khi ăn', 'Nơi khô ráo', '2024-04-28 09:02:36', 'daxetduyet');
...
(10, 'Hào Nguyên', 'hao@gmail.com', '202cb962ac59075b964b07152d234b70', '075652', 'Hựu Thành', 'vngoods_69_466816.jpg', 'Khachhang', 'hoatdong', '2024-04-28 07:58:29');
...
--
ALTER TABLE `caygiong`
  MODIFY `id_cg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `nhatkysanpham`
  MODIFY `id_nk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
