...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2024 at 07:45 PM
...
(1, 0, 1, 1, 'Cơ sở sản xuất Trà Mãng cầu Ánh Nguyệt', '5c2e785e2265042f842c4c4a583c5bb3.jpg', '0795972514', 'huynhquoctien.10a3.2017@gmail.com', 'Ấp Hiếu Trung A, Xã Hiếu Nghĩa, Vũng Liêm, Vĩnh Long', 'TPVT-P.4-NX01', '6626b5848e389_2901051_19.jpg', '6626b5848e486_2901099.jpg', '6626b5848e534_a0741c15180fc9d2c0d16a879f87598e.jpg', 'Tieens chos', '2024-04-22 16:23:25'),
(4, 0, 9, 6, 'MinhJet Ali', '371399452_1009194440311955_3419208062698528689_n.jpg', '1111111111', '1111@1111111112', '1111111112', '11111111112', '662bfc4bf00c0_2901100.jpg', '6626b406c5144_2901051_19.jpg', 'apple1.jpg', 'ok', '2024-04-22 18:38:56'),
(5, 0, 6, 4, 'Hợp tác xã Mãng Cầu xiêm Thuận Hoà', '6626b406c5144_2901051_19.jpg', '11111111', '111@1111', '11111111', '111', '6626b5848e389_2901051_19.jpg', '6626b5848e486_2901099.jpg', '2901459.jpg', '1111111111', '2024-04-23 10:52:25');
...
(6, 19, NULL, NULL, 3, 'Thăm vườn ổi', 'Thông báo này là một lỗi từ PHP, cụ thể là một lỗi \"unlink\". Hàm \"unlink\" được sử dụng để xóa một tệp (file) từ hệ thống tệp của máy chủ. Tuy nhiên, trong trường hợp này, PHP đã gặp vấn đề khi cố gắng xóa tệp \"uploads/WIN_20240123_22_25_18_Pro.jpg\" vì không tìm thấy tệp đó trong thư mục được chỉ định.\r\n\r\nCó thể có một số lý do dẫn đến lỗi này:\r\n\r\n1. **Tệp không tồn tại:** Có thể rằng tệp đã bị xóa hoặc đã được di chuyển sang một vị trí khác trước khi hàm \"unlink\" được gọi.\r\n  \r\n2. **Quyền truy cập không đúng:** PHP không có quyền truy cập để xóa tệp đó. Đảm bảo rằng quyền truy cập (permissions) cho tệp và thư mục đó được cấu hình đúng.\r\n\r\n3. **Đường dẫn không chính xác:** Có thể đã xảy ra lỗi khi tạo đường dẫn đến tệp.\r\n\r\nĐể khắc phục lỗi này, bạn có thể:\r\n\r\n- Kiểm tra xem tệp có tồn tại trong thư mục \"uploads\" không.\r\n- Đảm bảo rằng bạn đang sử dụng đúng đường dẫn tệp.\r\n- Đảm bảo rằng PHP có quyền truy cập để xóa tệp từ thư mục đó.\r\n- Kiểm tra xem có bất kỳ vấn đề nào với quyền truy cập hoặc phân quyền tệp.\r\n\r\nNếu không tìm thấy vấn đề nào trong các điều kiện trên, bạn có thể cần xem xét cách gọi hàm \"unlink\" để đảm bảo rằng nó được gọi đúng cách và với đúng đối số.', '9f07a85d7ff0087c7795b88a1de12c94.jpg', '2024-05-03 14:25:36'),
(7, 15, NULL, NULL, 39, 'Thăm vườn cam', 'Thông báo này là một lỗi từ PHP, cụ thể là một lỗi \"unlink\". Hàm \"unlink\" được sử dụng để xóa một tệp (file) từ hệ thống tệp của máy chủ. Tuy nhiên, trong trường hợp này, PHP đã gặp vấn đề khi cố gắng xóa tệp \"uploads/WIN_20240123_22_25_18_Pro.jpg\" vì không tìm thấy tệp đó trong thư mục được chỉ định.\r\n\r\nCó thể có một số lý do dẫn đến lỗi này:\r\n\r\n1. **Tệp không tồn tại:** Có thể rằng tệp đã bị xóa hoặc đã được di chuyển sang một vị trí khác trước khi hàm \"unlink\" được gọi.\r\n  \r\n2. **Quyền truy cập không đúng:** PHP không có quyền truy cập để xóa tệp đó. Đảm bảo rằng quyền truy cập (permissions) cho tệp và thư mục đó được cấu hình đúng.\r\n\r\n3. **Đường dẫn không chính xác:** Có thể đã xảy ra lỗi khi tạo đường dẫn đến tệp.\r\n\r\nĐể khắc phục lỗi này, bạn có thể:\r\n\r\n- Kiểm tra xem tệp có tồn tại trong thư mục \"uploads\" không.\r\n- Đảm bảo rằng bạn đang sử dụng đúng đường dẫn tệp.\r\n- Đảm bảo rằng PHP có quyền truy cập để xóa tệp từ thư mục đó.\r\n- Kiểm tra xem có bất kỳ vấn đề nào với quyền truy cập hoặc phân quyền tệp.\r\n\r\nNếu không tìm thấy vấn đề nào trong các điều kiện trên, bạn có thể cần xem xét cách gọi hàm \"unlink\" để đảm bảo rằng nó được gọi đúng cách và với đúng đối số.', 'mae-mu-U1iYwZ8Dx7k-unsplash.jpg', '2024-05-08 20:01:28');
...
(1, 0, 1, 1, 1, 3, 'Nhà xưởng tháng 2', 'NXT2', 'cf5fdedad7bccb40548c043704eae196.jpg', '086421212', 'MinhJet@12112', '16 lê thi thập', '12 m2', '662c0341d4b04_662c03041f4cc_2901099.jpg', '662e040cb9ba1_662bfc4bf00c0_2901100.jpg', '662c0341d4e9c_Black apple.jpg', ' Liên hệ anh tiến chó'),
(2, 0, 4, 9, 5, 8, 'Xưởng 03', '03NX', '371399452_1009194440311955_3419208062698528689_n.jpg', '0867512314', 'Alicia@gmail.com', 'Long Xuyên, An Giang', '120 m2', '662c03041f4cc_2901099.jpg', '662c03041f726_2901459.jpg', '662c03041f94b_tijana-drndarski-SJxDhVZR30I-unsplash.jpg', 'Liên hệ chị Alicia Meow'),
(3, 0, 3, 5, 4, 8, 'Nhà xưởng bán tạp hóa', 'TQPHOA1', 'monika-grabkowska-qSkWlOBHia0-unsplash.jpg', '075145271', 'nhuthao@gmail.com', 'Hựu thành, Trà Ôn, Vĩnh Long', '120 m2', '6626b5848e486_2901099.jpg', '6626b5848e534_a0741c15180fc9d2c0d16a879f87598e.jpg', '2901460.jpg', 'Liên hệ hào nguyễn');
...
(65, 5, 2, 2, 'Minh Jet', 'minhok3699@gmail.com', '202cb962ac59075b964b07152d234b70', '043212312', 'Vĩnh Long A', '53f46a097f18de468709.jpg', 'Đẹp trai', 'Admin', 'hoatdong', '', 1, '2024-05-08 21:55:26');
...
--
ALTER TABLE `nhatky`
  MODIFY `id_nk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
