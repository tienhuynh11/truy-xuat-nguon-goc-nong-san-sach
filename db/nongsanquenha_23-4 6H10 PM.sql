...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2024 at 01:10 PM
...
(1, 2, 1, 0, 3, 'Táo Newzeland', 'OHD-25550', '2901141.jpg', 'Từ 110.000 - 150.000 vnđ/kg', 'Vĩnh Long', 'jakshdkjhad.png', 'Táo đẹp', 'Bổ sung vitamin ABCDEFGHIKLMNO', '25/12/2024', 'Bảo quan nơi có ánh tối', '2024-03-13 03:07:04', 'daxetduyet'),
...
--
ALTER TABLE `nhatkysanpham`
  MODIFY `id_nk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `sanpham`
--
ALTER TABLE `sanpham`
  MODIFY `id_sp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `vungsanxuat`
  MODIFY `id_vung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
