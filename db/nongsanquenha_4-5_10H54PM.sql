...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2024 at 05:53 PM
...
CREATE TABLE `caygiong` (
  ...
  `nhanphanphoi` int(11) DEFAULT NULL,
...
INSERT INTO `caygiong` (`id_cg`, `nhasanxuat`, `nhanphanphoi`, `tencaygiong`, `macaygiong`, `mota`, `xuatxu`, `gia`, `ngaysanxuat`, `hansudung`, `hdsd`, `phuongphaptrong`, `hinhanh`, `lienhe`, `ngaytao`) VALUES
...
(1, 2, 8, 1, 8, NULL, NULL, NULL, NULL, NULL, NULL, 'Táo Newzeland', 'OHD-25550', '2901141.jpg', 'Từ 110.000 - 150.000 vnđ/kg', 'Vĩnh Long', 'jakshdkjhad.png', 'Táo đẹp   ', '   Bổ sung vitamin ABCDEFGHIKLMNO', '25/12/2024', '', 'Bảo quan nơi có ánh tối', '2024-03-13 03:07:04', 'daxetduyet'),
...
CREATE TABLE `taikhoan` (
  ...
  `role` enum('Admin','Nông dân','Chuyên viên') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Nông dân',
  `trangthai` enum('hoatdong','khonghoatdong') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'hoatdong',
  `ngaytao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 'Huỳnh Quốc Tiến', 'followme403@gmail.com', '7ab64083d8ff71645fd0bb3ce7e73418', '0795972514', 'Vĩnh Long', '2a2e42361e7fb321ea6e.jpg', '', 'hoatdong', '2024-03-07 16:51:16'),
...
(5, 'Ali', 'ly@gmail.com', '202cb962ac59075b964b07152d234b70', '1234511', '12312412', '662c03041f4cc_2901099.jpg', '', 'hoatdong', '2024-04-25 04:08:11'),
(6, 'Tiens Chos', 'aa@gmail.com', '202cb962ac59075b964b07152d234b70', '11', '11', '371399452_1009194440311955_3419208062698528689_n.jpg', '', 'hoatdong', '2024-04-25 04:08:28'),
(9, 'Trương Thị Lý', 'ly@gmail.com', '202cb962ac59075b964b07152d234b70', '0345128645', 'Gành Hào , Đông Hải. Bạc Liêu', 'ali.jpg', '', 'hoatdong', '2024-04-26 20:13:03'),
(10, 'Hào Nguyên', 'hao@gmail.com', '202cb962ac59075b964b07152d234b70', '075652', 'Hựu Thành', 'vngoods_69_466816.jpg', '', 'hoatdong', '2024-04-28 07:58:29');
...
ALTER TABLE `caygiong`
  ...
  ADD KEY `nhanphanphoi` (`nhanphanphoi`);
