<?php 
    ...
    if(isset($_POST['admin_btn'])){
        $log_msg = $obj->nongdan_login($_POST);
    }
    session_start();
                        ...
                        <form action="" method="post" class="md-float-material">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" placeholder="Email của bạn" name="nongdan_email">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <input type="password" class="form-control" placeholder="Mật khẩu" name="nongdan_pass">
                                    <span class="md-line"></span>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Cảm ơn bạn và hãy tận hưởng trang web của tôi.</p>
