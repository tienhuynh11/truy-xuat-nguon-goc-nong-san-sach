...
<div class="col-md-6 col-xl-3">
    <div class="card bg-c-yellow order-card">
        <div class="card-block">
            <h6 class="m-b-20">Tất cả sản phẩm</h6>
            <h2 class="text-right"><i class="fa fa-list f-left"></i><span id="pendingOrder"><?php echo $obj->xetduyet() ?></span></h2>
...
<div class="col-md-6 col-xl-3">
    <div class="card bg-c-yellow order-card">
        <div class="card-block">
            <h6 class="m-b-20">Sản phẩm đã duyệt</h6>
            <h2 class="text-right"><i class="fa fa-check f-left"></i><span id="pendingOrder"><?php echo $obj->xetduyet() ?></span></h2>
            <p class="m-b-0"><span class="f-right"></span></p>
        </div>
    </div>
</div>
...
<div class="col-md-6 col-xl-3">
    <div class="card bg-c-yellow order-card">
        <div class="card-block">
            <h6 class="m-b-20">Sản phẩm đang chờ xét duyệt</h6>
            <h2 class="text-right"><i class="ti-reload f-left"></i><span id="pendingOrder"><?php echo $obj->xetduyet() ?></span></h2>
            <p class="m-b-0"><span class="f-right"></span></p>
        </div>
    </div>
</div>
...
<div class="col-md-6 col-xl-3">
    <div class="card bg-c-yellow order-card">
        <div class="card-block">
            <h6 class="m-b-20">Nhà vận chuyển</h6>
            <h2 class="text-right"><i class="ti-reload f-left"></i><span id="pendingOrder"><?php echo $obj->xetduyet() ?></span></h2>
            <p class="m-b-0"><span class="f-right"></span></p>
        </div>
    </div>
