                ...
                <li>
                    ...
                    <div class="slide-contain biolife-banner__special">
                        <div class="banner-contain">
                            <div class="media">
                                <a href="single_product.php?status=singleproduct&&id=<?php echo $pdt_data['id_sp'] ?>" class="bn-link">
                                    <figure><img src="admin/uploads/<?php echo $pdt_data['hinhanh'] ?>" width="616" height="483" alt=""></figure>
                                </a>
                            </div>
                            <a href="single_product.php?status=singleproduct&&id=<?php echo $pdt_data['id_sp'] ?>">
                                <div class="text-content">
                                    <b class="first-line">Special Items</b>
                                    <span class="second-line"><?php echo $pdt_data['tensanpham'] ?></span>

                                    <div class="product-detail">

                                        <div class="price price-contain">
                                            <ins><span class="price-amount"><span class="currencySymbol">TK. </span><?php echo $pdt_data['gia'] ?></span></ins>
