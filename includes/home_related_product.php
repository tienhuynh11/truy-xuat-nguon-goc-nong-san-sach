...
<?php 
  ...
  $array_collum = array_column($five_catagories, "tendanhmuc");
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt_ctg_one['id_sp'] ?>" class="link-to-product">
                                                    <img src="admin/uploads/<?php echo $eight_pdt_ctg_one['hinhanh'] ?>" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories"><?php echo $eight_pdt_ctg_one['danhmuc'] ?></b>
                                                <h4 class="product-title"><a href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt['id_sp'] ?>" class="pr-name"><?php echo $eight_pdt_ctg_one['tensanpham'] ?></a></h4>
                                                <!-- <div class="price ">
                            ...
                            <div id="tab01_2nd" class="tab-contain ">
                                ...
                                <?php while($eight_pdt_ctg_two = mysqli_fetch_assoc($eight_pdt_form_ctg_two)){ ?>
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt_ctg_two['id_sp'] ?>" class="link-to-product">
                                                    <img src="admin/uploads/<?php echo $eight_pdt_ctg_two['hinhanh']?>" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                            ...
                            <div id="tab01_5th" class="tab-contain ">
                                ...
                                <?php while($eight_pdt_ctg_five = mysqli_fetch_assoc($eight_pdt_form_ctg_five)){ ?>
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt_ctg_five['id_sp'] ?>" class="link-to-product">
                                                    <img src="admin/uploads/<?php echo $eight_pdt_ctg_five['hinhanh']?>" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories"><?php echo $eight_pdt_ctg_five['danhmuc']?></b>
                                                <h4 class="product-title"><a href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt_ctg_five['id_sp'] ?>" class="pr-name"><?php echo $eight_pdt_ctg_five['tensanpham']?></a></h4>
                                                <!-- <div class="price ">
